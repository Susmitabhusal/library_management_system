...
btn4 = Button(root,text="Issue Book to Student",bg='black', fg='white', command = obj3.issueBook)
btn4.place(relx=0.28,rely=0.7, relwidth=0.45,relheight=0.1)
btn5 = Button(root,text="Return Book",bg='black', fg='white', command = obj4.returnBook)
